...
hostnameDoServidor = '192.168.1.4' // NÃO COLOCAR A "/" NO FINAL!
portaDoServidor = 810 // NÃO COLOCAR OS ":" NO COMEÇO!
enderecoDoCliente = 'http://192.168.1.4:8888/processamento?usuarioId=XXX'
...
configuracoesStatusBar = [
  {
    ...
    endpoint: "http://192.168.1.4:8080/metodos/liberaCatraca?sentidoHorarioLiberado=true&sentidoAntiHorarioLiberado=true&liberacaoTempo=10000&texto=LIBERADO",
    filtro: 'catraca1'
  },
  {
...
config = [
  {
    ...
    corFracasso: 'red',
    filtro: ['catraca1'],
    endpoint_lib_identificada: 'http://192.168.1.4:8080/metodos/liberaCatraca?sentidoHorarioLiberado=true&sentidoAntiHorarioLiberado=true&liberacaoTempo=10000&texto=LIBERADO'
  },
  {
